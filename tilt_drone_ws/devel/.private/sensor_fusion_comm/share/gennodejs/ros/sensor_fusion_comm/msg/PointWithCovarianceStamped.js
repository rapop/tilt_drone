...
class PointWithCovarianceStamped {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PointWithCovarianceStamped(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new PointWithCovarianceStamped(null);
...
module.exports = PointWithCovarianceStamped;
